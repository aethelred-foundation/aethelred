...
func (app *AethelredApp) SecureCellsGetHandler() http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if app.handleSecureCellGovernmentAgentExecutionLaunchPackageGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionLaunchCustodyGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionLaunchActivationGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionLaunchOrderGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionLaunchMonitorGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionLaunchReceiptIntakeGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionLaunchCloseoutGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionLaunchSettlementGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionLaunchArchiveCertificateGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionLaunchClosureRegistryGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionLaunchClosureBoardGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionLaunchClosureCommandCenterGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionLaunchClosureDashboardGet(w, r) {
			return
		}
		...
		if app.handleSecureCellGovernmentAgentExecutionLaunchClosureAutomationActionGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionLaunchClosureOverdueActionGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionLaunchClosureAutomationSummaryGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionLaunchClosureAutomationBoardGet(w, r) {
			return
		}
		...
		if app.handleSecureCellGovernmentAgentExecutionLaunchClosureAutomationRunbookGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionLaunchClosureAutomationBriefGet(w, r) {
			return
		}
		...
		if app.handleSecureCellGovernmentAgentExecutionLaunchClosureAutomationDirectiveGet(w, r) {
			return
		}
		...
		if app.handleSecureCellLaunchClosureAutomationAckReceiptGet(w, r) {
			return
		}
		...
		if app.handleSecureCellLaunchClosureAutomationAckReceiptEvidenceQueueGet(w, r) {
			return
		}

		if app.handleSecureCellLaunchClosureAutomationAckReceiptEvidenceDispatchGet(w, r) {
			return
		}

		if app.handleSecureCellLaunchClosureAutomationAckReceiptEvidenceDispatchAcceptanceGet(w, r) {
			return
		}

		if app.handleSecureCellLaunchClosureAutomationAckReceiptEvidenceDispatchAcceptanceReceiptGet(w, r) {
			return
		}
		...
		if app.handleSecureCellGovernmentAgentExecutionLaunchReceiptManifestGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionLaunchClearanceGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionLaunchAuthorizationGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionHandoffVerificationGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionHandoffBundleGet(w, r) {
			return
		}

		if app.handleSecureCellGovernmentAgentExecutionActionQueueGet(w, r) {
			return
		}
