...
/* eslint-disable */
  ...
  import type { IAggregatorV3, IAggregatorV3Interface } from "../../../contracts/InstitutionalStablecoinBridge.sol/IAggregatorV3.js";
  ...
  export class IAggregatorV3__factory {
    ...
    static connect(address: string, runner?: ContractRunner | null): IAggregatorV3 {
