...
pub enum EmbeddingModel {
    /// Legacy external embedding profile
    Legacy1536 { dimensions: usize },
    /// Compact external embedding profile
...
impl Default for VaultConfig {
    fn default() -> Self {
        VaultConfig {
            default_model: EmbeddingModel::Compact1536 { dimensions: 1536 },
...
mod tests {
    ...
    fn sample_embedding(id_byte: u8, value: f32, owner: [u8; 32]) -> VectorEmbedding {
        VectorEmbedding {
            ...
            dimensions: 1536,
            model: EmbeddingModel::Compact1536 { dimensions: 1536 },
            metadata: EmbeddingMetadata {
    ...
    fn test_attested_vector_vault_requires_real_backends() {
        ...
        let config = VaultConfig::attested_qdrant(
            EmbeddingModel::Compact1536 { dimensions: 1536 },
            IndexType::HNSW {
                m: 16,
                ef_construction: 200,
                ef_search: 100,
