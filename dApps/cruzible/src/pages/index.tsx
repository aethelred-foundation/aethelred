      ...
      <div className="relative max-w-[1440px] mx-auto px-6 pt-16 pb-20">
        ...
        <div className="max-w-2xl mx-auto mb-14" ref={searchRef}>
          <form onSubmit={handleSearchSubmit} className="relative">
            ...
            <button
              type="submit"
              className="absolute right-2 top-1/2 -translate-y-1/2 px-5 py-2.5 bg-red-600 hover:bg-red-700 text-white rounded-xl text-sm font-medium transition-colors"
            >
              Search
            </button>
          </form>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6">
          {[
            ...
            <div
              key={stat.label}
              className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-5 animate-fade-in-up"
            >
