...
|-------------|----------|------|-------------|-----------------|--------------|
| HS-2026-04-16-01 | High | Bridge (Rust) | Persist relayer state across restarts, require real burn nonces, ceil-round quorum thresholds, and fail closed on placeholder voting and submission paths | `ramesh/protocol-hardening-sweep-20260416` / PR `#141` | `cargo test -p aethelred-bridge` |
