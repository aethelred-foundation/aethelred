...
9. Workflow-free authority/disposition branches were pushed to both public repos (docs/manifests/security scope only):
   - `aethelred-foundation/aethelred-cosmos-node`: `governance/repo-authority-aethel-mr-001-noworkflows-20260224`
   - `aethelred-foundation/aethelred-core`: `governance/repo-authority-aethel-mr-001-noworkflows-20260224`
