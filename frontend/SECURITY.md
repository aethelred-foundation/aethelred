...
This repository (`aethelred-dashboard`) is in scope for security review for the code and configuration it contains.

Dashboard/frontend and developer UX surfaces.
