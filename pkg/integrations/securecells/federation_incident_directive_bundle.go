...
type SecureCellFederationIncidentDirectiveBundle struct {
	...
	ExtensionAppeals                 []SecureCellFederationIncidentDirectiveExtensionAppealSummary                `json:"extension_appeals,omitempty"`
	ExtensionAppealAutomationActions []SecureCellFederationIncidentDirectiveExtensionAppealAutomationActionRecord `json:"extension_appeal_automation_actions,omitempty"`
...
func (s *Service) BuildFederationIncidentDirectiveBundle(ctx context.Context, cellID string, directiveID string, options SecureCellFederationIncidentDirectiveBundleOptions) (*SecureCellFederationIncidentDirectiveBundle, error) {
	...
	extensionAppeals, err := s.ListFederationIncidentDirectiveExtensionAppeals(ctx, SecureCellFederationIncidentDirectiveExtensionAppealFilter{
		CellID:      cellID,
		DirectiveID: directive.ID,
	})
	if err != nil {
	...
	extensionAppealAutomationActions, err := s.ListFederationIncidentDirectiveExtensionAppealAutomationActions(ctx, SecureCellFederationIncidentDirectiveExtensionAppealAutomationActionFilter{
		CellID:      cellID,
		DirectiveID: directive.ID,
	})
	if err != nil {
	...
	bundle := &SecureCellFederationIncidentDirectiveBundle{
		...
		ExtensionAppeals:                 append([]SecureCellFederationIncidentDirectiveExtensionAppealSummary(nil), extensionAppeals...),
		ExtensionAppealAutomationActions: append([]SecureCellFederationIncidentDirectiveExtensionAppealAutomationActionRecord(nil), extensionAppealAutomationActions...),
