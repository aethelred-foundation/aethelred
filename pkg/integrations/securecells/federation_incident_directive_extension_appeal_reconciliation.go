...
type SecureCellFederationIncidentDirectiveExtensionAppealReconciliationBundle struct {
	...
	ChallengeAutomationActions       []SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAutomationActionRecord       `json:"challenge_automation_actions,omitempty"`
...
func (s *Service) BuildFederationIncidentDirectiveExtensionAppealReconciliationBundle(ctx context.Context, cellID string, comparisonKey string, options SecureCellFederationIncidentDirectiveExtensionAppealReconciliationBundleOptions) (*SecureCellFederationIncidentDirectiveExtensionAppealReconciliationBundle, error) {
	...
	challengeAppeals := make([]SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealSummary, 0)
	for _, challengeAppeal := range secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealsFromRun(run) {
		if strings.EqualFold(strings.TrimSpace(challengeAppeal.ComparisonKey), strings.TrimSpace(comparisonKey)) {
			challengeAppeals = append(challengeAppeals, challengeAppeal)
		}
	}
	...
	challengeAutomationActions, err := s.ListFederationIncidentDirectiveExtensionAppealReconciliationChallengeAutomationActions(ctx, SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAutomationActionFilter{
		CellID:        cellID,
		ComparisonKey: comparisonKey,
	})
	if err != nil {
	...
	challengeAppealAutomationActions, err := s.ListFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAutomationActions(ctx, SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAutomationActionFilter{
		CellID:        cellID,
		ComparisonKey: comparisonKey,
	})
	if err != nil {
	...
	bundle := &SecureCellFederationIncidentDirectiveExtensionAppealReconciliationBundle{
		...
		ChallengeAutomationActions:       append([]SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAutomationActionRecord(nil), challengeAutomationActions...),
