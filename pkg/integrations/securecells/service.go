...
const (
	...
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealIntakeAction                                                                             = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.intake"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentAckAction                                                                       = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.acknowledge"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentDisputeAction                                                                   = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.dispute"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentAutomationAckAction                                                             = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.automation.acknowledge"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentAutomationDisputeAction                                                         = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.automation.dispute"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentCorrectionAttestAction                                                          = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.attest_correction"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResolutionAttestAction                                                          = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.attest_resolution"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseIntakeAction                                                            = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.response.intake"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealAction                                                            = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.response.appeal"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealRuleAction                                                        = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.response.appeal.rule"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealDelegateReviewAction                                              = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.response.appeal.delegate_review"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealRecuseAction                                                      = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.response.appeal.recuse_review"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealRehearAction                                                      = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.response.appeal.rehear"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealAcknowledgeAction                                                 = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.response.appeal.acknowledge_enforcement"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyAcknowledgeAction                                     = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.response.appeal.acknowledge_counterparty_ruling"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyDisputeAction                                         = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.response.appeal.dispute_counterparty_ruling"
	...
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealIntakeAction                  = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.response.appeal.counterparty_review_appeal_review_appeal.intake"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealAcknowledgeAction             = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.response.appeal.counterparty_review_appeal_review_appeal.acknowledge_counterparty_ruling"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealDisputeAction                 = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.response.appeal.counterparty_review_appeal_review_appeal.dispute_counterparty_ruling"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealEscalateAction                = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.response.appeal.counterparty_review_appeal_review_appeal.escalate_counterparty_dispute"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleIntakeAction      = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.response.appeal.counterparty_review_appeal_review_appeal.review_bundle.intake"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleAcknowledgeAction = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.response.appeal.counterparty_review_appeal_review_appeal.review_bundle.acknowledge_counterparty_ruling"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleDisputeAction     = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.response.appeal.counterparty_review_appeal_review_appeal.review_bundle.dispute_counterparty_ruling"
	secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleEscalateAction    = "secure_cells.federation.incident.directive.extension.appeal.reconciliation.challenge_appeal.alignment.response.appeal.counterparty_review_appeal_review_appeal.review_bundle.escalate_counterparty_dispute"
...
// SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealBundleSigner
// signs a portable bilateral reconciliation challenge-appeal bundle.
type SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealBundleSigner func(ctx context.Context, bundle *SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealBundle) error

// SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseBundleSigner
// signs a portable bilateral challenge-appeal alignment response bundle.
type SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseBundleSigner func(ctx context.Context, bundle *SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseBundle) error

// SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewBundleSigner
...
// SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewBundleSigner
...
// SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleSigner
// signs a portable bilateral review bundle over imported reciprocal
// rehearing-board bundles.
type SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleSigner func(ctx context.Context, bundle *SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundle) error
...
type SecureCellResult struct {
	...
	FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppeals                                                                        []SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealSnapshot                                                                        `json:"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeals,omitempty"`
	FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponses                                                       []SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseSnapshot                                                       `json:"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_responses,omitempty"`
	FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppeals                         []SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealSnapshot                         `json:"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeals,omitempty"`
	FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppeals             []SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealSnapshot             `json:"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeals,omitempty"`
	FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundles []SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleSnapshot `json:"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundles,omitempty"`
...
func (s *Service) buildControlLedger(run *secureCellRun, receiptChain *policy.PolicyReceiptChain) (*evidence.ControlLedger, error) {
	...
	ledger.WithMetadata("federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeals_total", fmt.Sprintf("%d", len(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppeals)))
	ledger.WithMetadata("federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeals_verified", fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealsByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppeals, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealStatusVerified))))
	ledger.WithMetadata("federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeals_stale", fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealsByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppeals, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealStatusStale))))
	ledger.WithMetadata("federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeals_expired", fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealsByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppeals, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealStatusExpired))))
	ledger.WithMetadata("federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeals_invalid", fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealsByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppeals, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealStatusInvalid))))
	ledger.WithMetadata("federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_responses_total", fmt.Sprintf("%d", len(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponses)))
	ledger.WithMetadata("federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_responses_verified", fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponsesByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponses, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseStatusVerified))))
	ledger.WithMetadata("federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_responses_stale", fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponsesByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponses, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseStatusStale))))
	ledger.WithMetadata("federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_responses_expired", fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponsesByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponses, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseStatusExpired))))
	ledger.WithMetadata("federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_responses_invalid", fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponsesByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponses, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseStatusInvalid))))
	ledger.WithMetadata("federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeals_total", fmt.Sprintf("%d", len(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppeals)))
	ledger.WithMetadata("federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeals_verified", fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealsByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppeals, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealStatusVerified))))
	ledger.WithMetadata("federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeals_stale", fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealsByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppeals, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealStatusStale))))
	ledger.WithMetadata("federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeals_expired", fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealsByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppeals, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealStatusExpired))))
	ledger.WithMetadata("federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeals_invalid", fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealsByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppeals, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealStatusInvalid))))
	...
	federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealRecordIDs := make([]string, 0, len(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppeals))
	federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseRecordIDs := make([]string, 0, len(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponses))
	federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealRecordIDs := make([]string, 0, len(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppeals))
	federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealRecordIDs := make([]string, 0, len(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppeals))
	federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleRecordIDs := make([]string, 0, len(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundles))
	...
	federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentRecordIDs := make([]string, 0, len(run.result.Transitions))
	...
	federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewRecordIDs := make([]string, 0, len(run.result.Transitions))
	federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleReviewRecordIDs := make([]string, 0, len(run.result.Transitions))
	...
	for idx, transition := range run.result.Transitions {
		...
		if transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_bundle_ingested" {
			federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealRecordIDs = append(federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealRecordIDs, recordID)
		}
		if transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_bundle_ingested" {
			federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseRecordIDs = append(federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseRecordIDs, recordID)
		}
		if transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_bundle_ingested" {
			federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealRecordIDs = append(federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealRecordIDs, recordID)
		}
		if transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_bundle_ingested" {
			federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealRecordIDs = append(federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealRecordIDs, recordID)
		}
		if transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle_ingested" {
			federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleRecordIDs = append(federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleRecordIDs, recordID)
		}
		if transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_acknowledged" || transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_disputed" {
			federationLifecycleRecordIDs = append(federationLifecycleRecordIDs, recordID)
			federationIncidentDirectiveRecordIDs = append(federationIncidentDirectiveRecordIDs, recordID)
			federationIncidentDirectiveExtensionRecordIDs = append(federationIncidentDirectiveExtensionRecordIDs, recordID)
			federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentRecordIDs = append(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentRecordIDs, recordID)
		}
		if transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_automation_acknowledged" || transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_automation_disputed" || transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_correction_attested" || transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_resolution_attested" {
			federationLifecycleRecordIDs = append(federationLifecycleRecordIDs, recordID)
			federationIncidentDirectiveRecordIDs = append(federationIncidentDirectiveRecordIDs, recordID)
			federationIncidentDirectiveExtensionRecordIDs = append(federationIncidentDirectiveExtensionRecordIDs, recordID)
			federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseRecordIDs = append(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseRecordIDs, recordID)
		}
		if transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appealed" || transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_review_delegated" || transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_review_recused" || transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_rehearing_requested" || transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_vote_recorded" || transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_ruled" || transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_enforcement_acknowledged" {
			federationLifecycleRecordIDs = append(federationLifecycleRecordIDs, recordID)
			federationIncidentDirectiveRecordIDs = append(federationIncidentDirectiveRecordIDs, recordID)
			federationIncidentDirectiveExtensionRecordIDs = append(federationIncidentDirectiveExtensionRecordIDs, recordID)
		...
		if transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_ruling_acknowledged" ||
			transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_ruling_disputed" ||
			(transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_rehearing_requested" && strings.EqualFold(strings.TrimSpace(data["federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_counterparty_review_escalated"]), "true")) ||
			(transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_ruled" && strings.EqualFold(strings.TrimSpace(data["federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_counterparty_review_escalated"]), "true")) {
			federationLifecycleRecordIDs = append(federationLifecycleRecordIDs, recordID)
			federationIncidentDirectiveRecordIDs = append(federationIncidentDirectiveRecordIDs, recordID)
			federationIncidentDirectiveExtensionRecordIDs = append(federationIncidentDirectiveExtensionRecordIDs, recordID)
			federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyRecordIDs = append(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyRecordIDs, recordID)
		}
		if transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_ruled" &&
			strings.EqualFold(strings.TrimSpace(data["federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_counterparty_review_escalated"]), "true") {
		...
		if transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_ruling_acknowledged" ||
			transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_ruling_disputed" ||
			(transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_rehearing_requested" && strings.EqualFold(strings.TrimSpace(data["federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_escalated"]), "true")) ||
			(transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_ruled" && strings.EqualFold(strings.TrimSpace(data["federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_escalated"]), "true")) {
			federationLifecycleRecordIDs = append(federationLifecycleRecordIDs, recordID)
			federationIncidentDirectiveRecordIDs = append(federationIncidentDirectiveRecordIDs, recordID)
			federationIncidentDirectiveExtensionRecordIDs = append(federationIncidentDirectiveExtensionRecordIDs, recordID)
			federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewRecordIDs = append(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewRecordIDs, recordID)
		}
		if transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle_ruling_acknowledged" ||
			transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle_ruling_disputed" ||
			(transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_rehearing_requested" && strings.EqualFold(strings.TrimSpace(data["federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle_escalated"]), "true")) ||
			(transition.Action == "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_ruled" && strings.EqualFold(strings.TrimSpace(data["federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle_escalated"]), "true")) {
			federationLifecycleRecordIDs = append(federationLifecycleRecordIDs, recordID)
			federationIncidentDirectiveRecordIDs = append(federationIncidentDirectiveRecordIDs, recordID)
			federationIncidentDirectiveExtensionRecordIDs = append(federationIncidentDirectiveExtensionRecordIDs, recordID)
			federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleReviewRecordIDs = append(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleReviewRecordIDs, recordID)
		}
		...
		if strings.TrimSpace(data["federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_id"]) != "" && strings.EqualFold(strings.TrimSpace(data["federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_sweep_mode"]), "automated") {
			federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAutomationRecordIDs = append(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAutomationRecordIDs, recordID)
		}
	...
	if len(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAutomationRecordIDs) > 0 {
		challengeAppeals := secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealsFromRun(run)
		if err := ledger.AddControl(evidence.LedgerControl{
			ControlID:   "CELL-FED-25",
			ControlName: "Appeal Reconciliation Challenge Appeal Timed Supervision",
			Description: "Challenge-appeal board review and reciprocal enforcement acknowledgement are actively supervised with timed response escalation and fail-closed contract suspension when bilateral appeal governance stalls.",
			Status:      evidence.ControlSatisfied,
			EvidenceRefs: evidence.ControlEvidenceRefs{
				RecordIDs: append([]string(nil), federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAutomationRecordIDs...),
			},
			Metadata: map[string]string{
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_automation_actions_total": fmt.Sprintf("%d", len(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAutomationRecordIDs)),
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeals_total":                   fmt.Sprintf("%d", len(challengeAppeals)),
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeals_pending":                 fmt.Sprintf("%d", secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealStatusCount(challengeAppeals, SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealStatusPendingBoardReview)),
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeals_ratified":                fmt.Sprintf("%d", secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealStatusCount(challengeAppeals, SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealStatusRatified)),
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeals_overturned":              fmt.Sprintf("%d", secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealStatusCount(challengeAppeals, SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealStatusOverturned)),
	...
	if len(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealRecordIDs) > 0 {
		challengeAppeals := secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealsFromRun(run)
		recusalCount := secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealRecusalCount(challengeAppeals)
		delegationCount := secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealDelegationCount(challengeAppeals)
		rehearingCount := secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealRehearingCount(challengeAppeals)
		if recusalCount > 0 || rehearingCount > 0 {
			if err := ledger.AddControl(evidence.LedgerControl{
				ControlID:   "CELL-FED-26",
				ControlName: "Challenge Appeal Recusal And Rehearing Governance",
				Description: "Reconciliation challenge appeals preserve reviewer-conflict recusals and evidence-bearing rehearings, so bilateral challenge-board governance can recover from conflicts without losing lineage or falling back to ad hoc coordination.",
				Status:      evidence.ControlSatisfied,
				EvidenceRefs: evidence.ControlEvidenceRefs{
					RecordIDs: append([]string(nil), federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealRecordIDs...),
				},
				Metadata: map[string]string{
					"federation_incident_directive_extension_appeal_reconciliation_challenge_appeals_total":           fmt.Sprintf("%d", len(challengeAppeals)),
					"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_recusals_total":   fmt.Sprintf("%d", recusalCount),
					"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_rehearings_total": fmt.Sprintf("%d", rehearingCount),
					"federation_incident_directive_extension_appeal_reconciliation_challenge_appeals_pending":         fmt.Sprintf("%d", secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealStatusCount(challengeAppeals, SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealStatusPendingBoardReview)),
				},
			}); err != nil {
				return nil, err
		...
		if delegationCount > 0 {
			if err := ledger.AddControl(evidence.LedgerControl{
				ControlID:   "CELL-FED-27",
				ControlName: "Challenge Appeal Committee Quorum Recovery",
				Description: "Reconciliation challenge appeals restore stalled board review through evidence-bearing reviewer delegation, so bilateral appeal committees can recover quorum after recusal or under-populated reviewer sets without abandoning signed lineage.",
				Status:      evidence.ControlSatisfied,
				EvidenceRefs: evidence.ControlEvidenceRefs{
					RecordIDs: append([]string(nil), federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealRecordIDs...),
				},
				Metadata: map[string]string{
					"federation_incident_directive_extension_appeal_reconciliation_challenge_appeals_total":            fmt.Sprintf("%d", len(challengeAppeals)),
					"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_delegations_total": fmt.Sprintf("%d", delegationCount),
					"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_recusals_total":    fmt.Sprintf("%d", recusalCount),
					"federation_incident_directive_extension_appeal_reconciliation_challenge_appeals_pending":          fmt.Sprintf("%d", secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealStatusCount(challengeAppeals, SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealStatusPendingBoardReview)),
				},
			}); err != nil {
	...
	if len(federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealRecordIDs) > 0 {
		if err := ledger.AddControl(evidence.LedgerControl{
			ControlID:   "CELL-FED-28",
			ControlName: "Reciprocal Challenge Appeal Bundle Exchange",
			Description: "Signed bilateral reconciliation challenge-appeal bundles are imported, verified, and aligned against the local appeal-board trail so final appeal-board rulings remain portable and replayable across organizations instead of being trapped inside one local case pack.",
			Status:      evidence.ControlSatisfied,
			EvidenceRefs: evidence.ControlEvidenceRefs{
				RecordIDs: append(append([]string(nil), federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealRecordIDs...), federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealRecordIDs...),
			},
			Metadata: map[string]string{
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeals_total":                 fmt.Sprintf("%d", len(secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealsFromRun(run))),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeals_total":    fmt.Sprintf("%d", len(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppeals)),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeals_verified": fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealsByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppeals, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealStatusVerified))),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeals_stale":    fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealsByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppeals, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealStatusStale))),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeals_expired":  fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealsByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppeals, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealStatusExpired))),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeals_invalid":  fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealsByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppeals, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealStatusInvalid))),
			},
		}); err != nil {
	...
	if len(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentRecordIDs) > 0 {
		challengeAppeals := secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealsFromRun(run)
		if err := ledger.AddControl(evidence.LedgerControl{
			ControlID:   "CELL-FED-29",
			ControlName: "Reciprocal Challenge Appeal Alignment Governance",
			Description: "Imported reconciliation challenge-appeal bundles are not passive snapshots; the latest reciprocal appeal-board artifact is explicitly acknowledged or disputed as evidence-bearing bilateral governance tied back to the exact reviewed snapshot.",
			Status:      evidence.ControlSatisfied,
			EvidenceRefs: evidence.ControlEvidenceRefs{
				RecordIDs: append([]string(nil), federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentRecordIDs...),
			},
			Metadata: map[string]string{
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_actions_total": fmt.Sprintf("%d", len(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentRecordIDs)),
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeals_total":                  fmt.Sprintf("%d", len(challengeAppeals)),
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeals_pending":                fmt.Sprintf("%d", secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealStatusCount(challengeAppeals, SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealStatusPendingBoardReview)),
			},
		}); err != nil {
	...
	if len(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentAutomationRecordIDs) > 0 {
		if err := ledger.AddControl(evidence.LedgerControl{
			ControlID:   "CELL-FED-30",
			ControlName: "Timed Reciprocal Challenge Appeal Alignment Supervision",
			Description: "Reciprocal challenge-appeal alignment is continuously supervised so overdue imported appeal-board bundles trigger evidence-bearing escalation or fail-closed contract suspension instead of remaining unreviewed bilateral blind spots.",
			Status:      evidence.ControlSatisfied,
			EvidenceRefs: evidence.ControlEvidenceRefs{
				RecordIDs: append([]string(nil), federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentAutomationRecordIDs...),
			},
			Metadata: map[string]string{
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_automation_actions_total": fmt.Sprintf("%d", len(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentAutomationRecordIDs)),
			},
		}); err != nil {
			return nil, err
		}
	}
	if len(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseRecordIDs) > 0 {
		if err := ledger.AddControl(evidence.LedgerControl{
			ControlID:   "CELL-FED-31",
			ControlName: "Reciprocal Challenge Appeal Alignment Exception Governance",
			Description: "Automated reciprocal challenge-appeal alignment actions do not end at escalation or suspension; bilateral acknowledgement, dispute, correction, and resolution attestations extend those automated controls into a replayable cross-organization exception-governance trail.",
			Status:      evidence.ControlSatisfied,
			EvidenceRefs: evidence.ControlEvidenceRefs{
				RecordIDs: append([]string(nil), federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseRecordIDs...),
			},
			Metadata: map[string]string{
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_actions_total": fmt.Sprintf("%d", len(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseRecordIDs)),
			},
		}); err != nil {
			return nil, err
		}
	}
	if len(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealRecordIDs) > 0 {
		...
		if err := ledger.AddControl(evidence.LedgerControl{
			ControlID:   "CELL-FED-32",
			ControlName: "Alignment Response Correction Board Governance",
			Description: "Disputed bilateral challenge-appeal alignment responses escalate into thresholded correction-board rulings and reciprocal enforcement acknowledgements, so automated cross-organization alignment exceptions can be appealed without collapsing back into ad hoc operator coordination.",
			Status:      evidence.ControlSatisfied,
			EvidenceRefs: evidence.ControlEvidenceRefs{
				RecordIDs: append([]string(nil), federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealRecordIDs...),
			},
			Metadata: map[string]string{
	...
	if len(federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseRecordIDs) > 0 {
		if err := ledger.AddControl(evidence.LedgerControl{
			ControlID:   "CELL-FED-34",
			ControlName: "Reciprocal Alignment Response Appeal Bundle Exchange",
			Description: "Signed bilateral correction-board bundles are imported, verified, and mapped onto stable local response-appeal lineage so counterparty rulings stay portable, replayable, and reviewable instead of becoming opaque off-platform decisions.",
			Status:      evidence.ControlSatisfied,
			EvidenceRefs: evidence.ControlEvidenceRefs{
				RecordIDs: append(append([]string(nil), federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealRecordIDs...), federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseRecordIDs...),
			},
			Metadata: map[string]string{
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeals_total":          fmt.Sprintf("%d", len(secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealsFromRun(run))),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_responses_total":    fmt.Sprintf("%d", len(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponses)),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_responses_verified": fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponsesByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponses, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseStatusVerified))),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_responses_stale":    fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponsesByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponses, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseStatusStale))),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_responses_expired":  fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponsesByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponses, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseStatusExpired))),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_responses_invalid":  fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponsesByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponses, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseStatusInvalid))),
			},
		}); err != nil {
	...
	if len(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyRecordIDs) > 0 {
		counterpartyResponseAppeals := secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealsFromRun(run)
		if err := ledger.AddControl(evidence.LedgerControl{
			ControlID:   "CELL-FED-35",
			ControlName: "Counterparty Correction Board Ruling Review",
			Description: "Imported correction-board rulings must be explicitly acknowledged, disputed, escalated, and resolved against the exact signed counterparty snapshot, preserving a replayable bilateral review trail over each cross-organization board outcome instead of trusting an implicit latest state.",
			Status:      evidence.ControlSatisfied,
			EvidenceRefs: evidence.ControlEvidenceRefs{
				RecordIDs: append([]string(nil), federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyRecordIDs...),
			},
			Metadata: map[string]string{
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_counterparty_review_actions_total": fmt.Sprintf("%d", len(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyRecordIDs)),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeals_total":        fmt.Sprintf("%d", len(counterpartyResponseAppeals)),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeals_acknowledged": fmt.Sprintf("%d", secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseReviewStatusCount(counterpartyResponseAppeals, SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewStatusAcknowledged)),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeals_disputed":     fmt.Sprintf("%d", secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseReviewStatusCount(counterpartyResponseAppeals, SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewStatusDisputed)),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeals_escalated":    fmt.Sprintf("%d", secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseReviewStatusCount(counterpartyResponseAppeals, SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewStatusEscalated)),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeals_resolved":     fmt.Sprintf("%d", secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseReviewStatusCount(counterpartyResponseAppeals, SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewStatusResolved)),
			},
		}); err != nil {
			return nil, err
		}
	...
	if len(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealRecordIDs) > 0 {
		responseAppeals := secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealsFromRun(run)
		responseAppealRecusals, _ := s.ListFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealRecusals(context.Background(), SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealRecusalFilter{CellID: run.result.CellID})
		rehearingCount := 0
		...
		if err := ledger.AddControl(evidence.LedgerControl{
			ControlID:   "CELL-FED-36",
			ControlName: "Alignment Response Appeal Rehearing And Recusal Governance",
			Description: "Correction-board response appeals support explicit rehearing lineage and reviewer recusal evidence, so bilateral appeal boards can recover from challenged or conflicted rulings without obscuring reviewer conflicts or losing traceable board generations.",
			Status:      evidence.ControlSatisfied,
			EvidenceRefs: evidence.ControlEvidenceRefs{
				RecordIDs: append([]string(nil), federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealRecordIDs...),
			},
	...
	if len(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyResolutionRecordIDs) > 0 {
		counterpartyResponseAppeals := secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealsFromRun(run)
		if err := ledger.AddControl(evidence.LedgerControl{
			ControlID:   "CELL-FED-38",
			ControlName: "Counterparty Ruling Dispute Resolution",
			Description: "Escalated disputes over imported counterparty correction-board rulings are closed through a fresh ruled rehearing generation, preserving the linked bilateral resolution outcome inside the same signed review trail instead of leaving operators to infer closure from disconnected board state.",
			Status:      evidence.ControlSatisfied,
			EvidenceRefs: evidence.ControlEvidenceRefs{
				RecordIDs: append([]string(nil), federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyResolutionRecordIDs...),
			},
			Metadata: map[string]string{
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_counterparty_resolutions_total": fmt.Sprintf("%d", len(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyResolutionRecordIDs)),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeals_total":     fmt.Sprintf("%d", len(counterpartyResponseAppeals)),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeals_resolved":  fmt.Sprintf("%d", secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseReviewStatusCount(counterpartyResponseAppeals, SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewStatusResolved)),
			},
		}); err != nil {
	...
	if len(federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealRecordIDs) > 0 {
		if err := ledger.AddControl(evidence.LedgerControl{
			ControlID:   "CELL-FED-39",
			ControlName: "Reciprocal Imported-Ruling Appeal Board Bundle Exchange",
			Description: "Signed bilateral imported-ruling appeal-board bundles are imported against the exact reviewed local response-appeal lineage, so reciprocal correction-board outcomes remain portable, verifiable, and queryable instead of disappearing into external correspondence.",
			Status:      evidence.ControlSatisfied,
			EvidenceRefs: evidence.ControlEvidenceRefs{
				RecordIDs: append([]string(nil), federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealRecordIDs...),
			},
			Metadata: map[string]string{
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeals_total":    fmt.Sprintf("%d", len(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppeals)),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeals_verified": fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealsByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppeals, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealStatusVerified))),
	...
	if len(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewRecordIDs) > 0 {
		counterpartyReviewAppeals, _ := s.ListFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppeals(context.Background(), SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealFilter{CellID: run.result.CellID})
		if err := ledger.AddControl(evidence.LedgerControl{
			...
			Metadata: map[string]string{
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_actions_total":       fmt.Sprintf("%d", len(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewRecordIDs)),
	...
	if len(federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealRecordIDs) > 0 {
		counterpartyReviewAppealReviewAppeals, _ := s.ListFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppeals(context.Background(), SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealFilter{CellID: run.result.CellID})
		if err := ledger.AddControl(evidence.LedgerControl{
			ControlID:   "CELL-FED-42",
			ControlName: "Reciprocal Imported Review Rehearing Bundle Exchange",
			Description: "Signed bilateral rehearing-board bundles over imported review disputes are imported against the exact local response-appeal lineage, so cross-organization counter-rulings remain portable, verifiable, and queryable instead of falling back to opaque side-channel handoff.",
			Status:      evidence.ControlSatisfied,
			EvidenceRefs: evidence.ControlEvidenceRefs{
				RecordIDs: append([]string(nil), federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealRecordIDs...),
			},
			Metadata: map[string]string{
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeals_total":    fmt.Sprintf("%d", len(counterpartyReviewAppealReviewAppeals)),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeals_verified": fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealsByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppeals, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealStatusVerified))),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeals_stale":    fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealsByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppeals, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealStatusStale))),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeals_expired":  fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealsByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppeals, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealStatusExpired))),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeals_invalid":  fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealsByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppeals, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealStatusInvalid))),
			},
		}); err != nil {
			return nil, err
		}
	}
	if len(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewRecordIDs) > 0 {
		reviewAppealReviewActions, _ := s.ListFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewActions(context.Background(), SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewFilter{CellID: run.result.CellID})
		acknowledgedCount := 0
		disputedCount := 0
		escalatedCount := 0
		resolvedCount := 0
		for _, item := range reviewAppealReviewActions {
			switch item.Action {
			...
			case SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewActionDispute:
				disputedCount++
			case SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewActionEscalate:
				escalatedCount++
			case SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewActionResolve:
				resolvedCount++
			}
		}
		if err := ledger.AddControl(evidence.LedgerControl{
			ControlID:   "CELL-FED-43",
			ControlName: "Reciprocal Rehearing Review Governance",
			Description: "Imported reciprocal rehearing-board bundles are not treated as implicitly accepted: operators can explicitly acknowledge or dispute each signed counterparty ruling, escalate unresolved divergence into a fresh governed rehearing, and close the review trail through the resulting ruled response instead of relying on off-ledger coordination.",
			Status:      evidence.ControlSatisfied,
			EvidenceRefs: evidence.ControlEvidenceRefs{
				RecordIDs: append([]string(nil), federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewRecordIDs...),
			},
			Metadata: map[string]string{
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_actions_total":      fmt.Sprintf("%d", len(reviewAppealReviewActions)),
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_acknowledged_total": fmt.Sprintf("%d", acknowledgedCount),
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_disputed_total":     fmt.Sprintf("%d", disputedCount),
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_escalated_total":    fmt.Sprintf("%d", escalatedCount),
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_resolved_total":     fmt.Sprintf("%d", resolvedCount),
			},
		}); err != nil {
			return nil, err
		}
	}
	if len(federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleRecordIDs) > 0 {
		reviewBundles, _ := s.ListFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundles(context.Background(), SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleFilter{CellID: run.result.CellID})
		if err := ledger.AddControl(evidence.LedgerControl{
			ControlID:   "CELL-FED-44",
			ControlName: "Reciprocal Rehearing Review Bundle Intake",
			Description: "Signed reciprocal rehearing review bundles are imported as first-class verifiable cross-organization evidence with exact rehearing-board lineage, signer status, expiry status, and operator query/export visibility.",
			Status:      evidence.ControlSatisfied,
			EvidenceRefs: evidence.ControlEvidenceRefs{
				RecordIDs: append([]string(nil), federationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleRecordIDs...),
			},
			Metadata: map[string]string{
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundles_total":    fmt.Sprintf("%d", len(reviewBundles)),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundles_verified": fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundlesByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundles, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealStatusVerified))),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundles_stale":    fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundlesByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundles, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealStatusStale))),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundles_expired":  fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundlesByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundles, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealStatusExpired))),
				"federation_counterparty_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundles_invalid":  fmt.Sprintf("%d", len(secureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundlesByStatus(run.result.FederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundles, SecureCellFederationCounterpartyIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealStatusInvalid))),
			},
		}); err != nil {
			return nil, err
		}
	}
	if len(federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleReviewRecordIDs) > 0 {
		reviewBundleActions, _ := s.ListFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleReviewActions(context.Background(), SecureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleReviewFilter{CellID: run.result.CellID})
		acknowledgedCount := 0
		disputedCount := 0
		escalatedCount := 0
		resolvedCount := 0
		for _, item := range reviewBundleActions {
			switch item.Action {
		...
		if err := ledger.AddControl(evidence.LedgerControl{
			ControlID:   "CELL-FED-45",
			ControlName: "Reciprocal Review Bundle Ruling Governance",
			Description: "Imported reciprocal review bundles must be locally acknowledged, disputed, escalated into a fresh governed rehearing, or resolved through the resulting signed ruling, closing the bilateral loop as an incident-command fabric rather than a static export handoff.",
			Status:      evidence.ControlSatisfied,
			EvidenceRefs: evidence.ControlEvidenceRefs{
				RecordIDs: append([]string(nil), federationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleReviewRecordIDs...),
			},
			Metadata: map[string]string{
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle_review_actions_total":      fmt.Sprintf("%d", len(reviewBundleActions)),
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle_review_acknowledged_total": fmt.Sprintf("%d", acknowledgedCount),
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle_review_disputed_total":     fmt.Sprintf("%d", disputedCount),
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle_review_escalated_total":    fmt.Sprintf("%d", escalatedCount),
				"federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle_review_resolved_total":     fmt.Sprintf("%d", resolvedCount),
			},
		}); err != nil {
			return nil, err
		}
...
func transitionStageForAction(action string) string {
	...
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_review_delegated":
		return "delegate_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_review"
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_rehearing_requested":
		return "rehear_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal"
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_review_recused":
		return "recuse_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_review"
	...
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_bundle_ingested":
		return "intake_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_bundle"
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_acknowledged":
		return "acknowledge_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment"
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_disputed":
		return "dispute_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment"
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_automation_acknowledged":
		return "acknowledge_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_automation"
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_automation_disputed":
		return "dispute_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_automation"
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_correction_attested":
		return "attest_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_correction"
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_resolution_attested":
		return "attest_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_resolution"
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_bundle_ingested":
		return "intake_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_bundle"
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appealed":
		return "appeal_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response"
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_review_delegated":
		return "delegate_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_review"
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_review_recused":
		return "recuse_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_review"
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_rehearing_requested":
		return "rehear_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal"
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_vote_recorded", "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_ruled":
		return "rule_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal"
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_enforcement_acknowledged":
		return "acknowledge_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_enforcement"
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_ruling_acknowledged":
		return "acknowledge_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_ruling"
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_ruling_disputed":
		return "dispute_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_ruling"
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_bundle_ingested":
		return "intake_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_bundle"
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_ruling_acknowledged":
		return "acknowledge_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_ruling"
	case "secure_cell.federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_ruling_disputed":
		return "dispute_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_ruling"
	...
	return &policy.PolicySet{
		...
		Scope: &policy.Scope{
			...
			Actions: []string{
				...
				secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealIntakeAction,
				secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentAckAction,
				secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentDisputeAction,
				secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentAutomationAckAction,
				secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentAutomationDisputeAction,
				secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentCorrectionAttestAction,
				secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResolutionAttestAction,
				secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseIntakeAction,
				secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealAction,
				secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealRuleAction,
				secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealDelegateReviewAction,
				secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealRecuseAction,
				secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealRehearAction,
				secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealAcknowledgeAction,
				secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyAcknowledgeAction,
				secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyDisputeAction,
		...
		Rules: []policy.Rule{
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_intake_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "intake_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_bundle"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_recuse_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "recuse_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_review"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_delegate_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "delegate_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_review"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_rehear_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "rehear_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_acknowledge_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "acknowledge_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_dispute_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "dispute_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_automation_acknowledge_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "acknowledge_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_automation"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_automation_dispute_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "dispute_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_automation"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_attest_correction_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "attest_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_correction"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_attest_resolution_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "attest_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_resolution"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_intake_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "intake_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_bundle"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "appeal_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_rule_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "rule_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_delegate_review_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "delegate_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_review"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_recuse_review_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "recuse_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_review"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_rehear_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "rehear_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_acknowledge_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "acknowledge_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_enforcement"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_acknowledge_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "acknowledge_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_ruling"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_dispute_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "dispute_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_ruling"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_intake_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "intake_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_bundle"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_intake_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "intake_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_bundle"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_acknowledge_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "acknowledge_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_ruling"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_dispute_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "dispute_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_ruling"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_escalate_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "escalate_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_dispute"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle_intake_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "intake_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle_acknowledge_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "acknowledge_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle_ruling"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle_dispute_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "dispute_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle_ruling"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle_escalate_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "escalate_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle_dispute"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_acknowledge_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "acknowledge_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_ruling"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
			...
			policy.NewAllowRule("secure_cell_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_dispute_allow", []policy.Condition{
				{Field: "cell_stage", Operator: policy.Equals, Value: "dispute_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_ruling"},
				{Field: "tool_allowed", Operator: policy.Equals, Value: "true"},
				{Field: "capability_present", Operator: policy.Equals, Value: "true"},
				{Field: "liability_profile_present", Operator: policy.Equals, Value: "true"},
				{Field: "jurisdiction_allowed", Operator: policy.Equals, Value: "true"},
...
func actionForStage(stage string) string {
	...
	case "intake_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_bundle":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealIntakeAction
	case "acknowledge_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentAckAction
	case "dispute_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentDisputeAction
	case "acknowledge_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_automation":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentAutomationAckAction
	case "dispute_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_automation":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentAutomationDisputeAction
	case "attest_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_correction":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentCorrectionAttestAction
	case "attest_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_resolution":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResolutionAttestAction
	case "appeal_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealAction
	case "intake_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_bundle":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseIntakeAction
	case "rule_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealRuleAction
	case "delegate_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_review":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealDelegateReviewAction
	case "recuse_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_review":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealRecuseAction
	case "rehear_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealRehearAction
	case "acknowledge_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_enforcement":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealAcknowledgeAction
	case "acknowledge_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_ruling":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyAcknowledgeAction
	case "dispute_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_ruling":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyDisputeAction
	case "intake_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_bundle":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealIntakeAction
	case "intake_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_bundle":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealIntakeAction
	case "acknowledge_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_ruling":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealAcknowledgeAction
	case "dispute_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_ruling":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealDisputeAction
	case "escalate_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_dispute":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealEscalateAction
	case "intake_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleIntakeAction
	case "acknowledge_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle_ruling":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleAcknowledgeAction
	case "dispute_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle_ruling":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleDisputeAction
	case "escalate_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_review_appeal_review_bundle_dispute":
		return secureCellFederationIncidentDirectiveExtensionAppealReconciliationChallengeAppealAlignmentResponseAppealCounterpartyReviewAppealReviewAppealReviewBundleEscalateAction
	case "acknowledge_federation_incident_directive_extension_appeal_reconciliation_challenge_appeal_alignment_response_appeal_counterparty_review_appeal_ruling":
