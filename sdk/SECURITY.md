...
This repository (`aethelred-sdks`) is in scope for security review for the code and configuration it contains.

Official multi-language SDKs (Python, TypeScript, Rust, Go).
