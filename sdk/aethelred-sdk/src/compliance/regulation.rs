...
impl RegulationInfo {
    ...
    pub fn hipaa() -> Self {
        RegulationInfo {
            ...
            official_name: "Health Insurance Portability and Accountability Act of 1996".to_string(),
            ...
            key_articles: vec![
                ...
                RegulationArticle {
                    ...
                    summary: "Access controls, audit controls, integrity, transmission security".to_string(),
                    high_risk: true,
                },
                RegulationArticle {
    ...
    pub fn uae_data_protection() -> Self {
        RegulationInfo {
            ...
            official_name: "UAE Federal Decree-Law No. 45 of 2021 on Personal Data Protection".to_string(),
            ...
            key_articles: vec![
                RegulationArticle {
                    ...
                    summary: "Lawfulness, transparency, purpose limitation, data minimisation".to_string(),
                    high_risk: true,
                },
                RegulationArticle {
                    number: "Article 22".to_string(),
                    title: "Cross-border transfer".to_string(),
                    summary: "Transfer to countries with adequate protection or with safeguards".to_string(),
                    high_risk: true,
                },
            ],
            fines: Some(FineStructure {
