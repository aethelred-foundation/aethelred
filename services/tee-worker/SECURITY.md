...
This repository (`aethelred-tee-worker`) is in scope for security review for the code and configuration it contains.

TEE worker, Nitro SDK, executor, and L1 verification services.
