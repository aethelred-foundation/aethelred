    ...
    Repository: `aethelred-tee-worker`
    ...
    - Attestation trust roots and parsing
- Parent <-> enclave message integrity/replay
- Secrets/material handling in memory and on disk
