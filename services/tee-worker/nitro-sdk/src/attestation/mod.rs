...
impl TcbStatus {
    ...
    pub fn is_acceptable(&self) -> bool {
        matches!(self, TcbStatus::UpToDate | TcbStatus::ConfigurationNeeded)
    }
...
pub enum CollateralSource {
    ...
    IntelPccs {
        /// PCCS endpoint URL used to fetch Intel collateral.
        url: String,
    },
    /// AMD Key Distribution Service
    AmdKds {
        /// AMD KDS endpoint URL used to fetch VCEK collateral.
        url: String,
    },
