...
impl SignatureAlgorithm {
    ...
    pub fn is_hybrid(&self) -> bool {
        matches!(
            self,
            SignatureAlgorithm::HybridEcdsaDilithium3 | SignatureAlgorithm::HybridEd25519Dilithium3
        )
    }
...
pub trait SerializableKey {
        ...
        Self: Sized,
    {
        let bytes = match format {
            ...
            KeyEncoding::Base64 => base64::engine::general_purpose::STANDARD
                .decode(s)
                .map_err(|e| CryptoError::InvalidKeyFormat(e.to_string()))?,
            KeyEncoding::Hex => {
                hex::decode(s).map_err(|e| CryptoError::InvalidKeyFormat(e.to_string()))?
            }
            KeyEncoding::Pem => {
