...
This repository (`aethelred-developer-tools`) is in scope for security review for the code and configuration it contains.

Developer tooling (CLI, local testnet, VS Code extension, utilities).
