...
impl Default for TestnetConfig {
    fn default() -> Self {
        TestnetConfig {
            ...
            rpc_endpoints: vec![
                "https://rpc.testnet.aethelred.io".to_string(),
                "https://rpc-2.testnet.aethelred.io".to_string(),
                "https://rpc-3.testnet.aethelred.io".to_string(),
            ],
            ws_endpoints: vec![
                "wss://ws.testnet.aethelred.io".to_string(),
                "wss://ws-2.testnet.aethelred.io".to_string(),
            ],
            explorer_url: "https://explorer.testnet.aethelred.io".to_string(),
            faucet_url: "https://faucet.testnet.aethelred.io".to_string(),
            api_base_url: "https://api.testnet.aethelred.io".to_string(),
            block_time_ms: 2000,
